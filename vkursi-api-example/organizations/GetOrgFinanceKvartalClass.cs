...
namespace vkursi_api_example.organizations.FinanceKvartal
{
    public class GetOrgFinanceKvartalClass
    {
        /*

       163. Аналіз фінансових показників підприємства за кодом ЄДРПОУ 
       та обраним типом перший квартал, півріччя, дев'ять місяців, річна)
       ...
       */
        ...
        public static GetOrgFinanceResponseModel GetOrgFinanceKvartal(ref string token, string edrpou, int kvartal)
        {
            ...
            {
                RestClient client = new RestClient("https://vkursi-api.azurewebsites.net/api/1.0/organizations/GetOrgFinanceKvartal");
