...
namespace vkursi_api_example.organizations
{
    ...
    */
    ...
    public class RussianFoundersAndBeneficiares
    {
        ...
        ///1 - засновник
        ///2 - бенеціфіар
        ///3 - Власник пакетів акцій
        ///4 - компанія засновник Українська але має зв'язки з росією або білорусією
        ///5 - Віддалений звязок(який має вплив через 2 і більше контролюючих суб'єктів)
        /// </summary>
